...
?>
	...
	echo $_GET['module'];
?>"><img src="../css/img/back.png" height="32px" width="32px"/>Back</a>
    </div>
    
        <div class="cleaner"></div>
                    <div class="subhead">
    				    <?php
	include (ADMIN_TPL_MODULE . 'form/' . $_GET['module'] . '.php');
?>
    				</div>
...
<div class="top_bar"><a href="home.php?module=<?php
	echo $_GET['module'];
?>&action=add"><img src="../css/img/add.png" height="32px" width="32px"/>Add <?php
	echo $module_Title;
?></a></div>
<div id="dynamic"></div>
...
?>
	...
	foreach ($_data as $row)
	{
		...
		if (isset($_extraModule))
		{
			...
			{
				echo '<td class=""  ><a href="home.php?module=' . $row1[1] . '&_Id=' . $row[$prefix .
					'uin'] . '">' . $row1[0] . ' </a></td>';
			}
		}
?>
...
?>">
                        ...
                        <a onclick="test(this.id)" href="#" id="<?php
