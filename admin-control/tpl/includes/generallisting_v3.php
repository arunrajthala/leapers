...
<form method="post" enctype="multipart/form-data">
	...
	if (isset($_GET['action'])) {
		...
		<div class="top_bar"><a href="home.php?module=<?php
			...
			if (getREQUEST('Type'))
				echo '&Type=' . getREQUEST('Type')
				?>&action=add"><img src="../css/img/add.png" height="32px" width="32px"/>Add <?php echo $module_Title; ?></a></div>
		<div id="dynamic"></div>
		...
		<table width="100%" cellspacing="0" cellpadding="0" border="0" id="_table" class="display dataTable" aria-describedby="_table_info" style="width: 100%;">
			...
			<tbody role="alert" aria-live="polite" aria-relevant="all">
				...
				<td class="center"><a href="home.php?module=<?php echo $_GET['module']; ?>&amp;action=edit&amp;_Id=<?php
									  echo $row[$prefix . 'uin'];
									  if (getREQUEST('Type'))
										  echo '&Type=' . getREQUEST('Type')
										  ?>">
