    function LiveProgs()
    {
        $( "#onAir" ).load( "ajax/OnAir.php" );
        setTimeout('LiveProgs()',5000);
        //$( "#onAir" ).load( "ajax/ArticleList.php?page=1&per=1" );
    }
    ...
    function PageMe_Dynamic_paper(TotalPage,Page,Per,scroll,id,where)
    {
        ...
        if(Page!=1)
        {
            onClk="PageMe_Dynamic_paper('"+TotalPage+"',"+(Page-1)+","+Per+",true,'"+id+"','"+where+"')";
            active='ellipse';
        }
        else
        {
        ...
        for(i=0;i<TotalPage;i++)
        {
            ...
            {
                active='ellipse';
                onClk="PageMe_Dynamic_paper('"+TotalPage+"',"+ct+","+Per+",true,'"+id+"','"+where+"')";
            }
            if(TotalPage>15)
            {
                //alert(ct);
        ...
        if(Page<(ct-1))
        {
            onClk="PageMe_Dynamic_paper('"+TotalPage+"',"+(Page+1)+","+Per+",true,'"+id+"')";
            active='ellipse';
        }
        else
        {
        ...
        if(typeof(id)!='undefined') 
        {
            ...
            {
                //alert(id);
                getNews_Dynamic_paper('news01uin='+id,'',Page,Per);
            }
            else
            {
                getNews_Dynamic_paper(where,'',Page,Per);
            }
    ...
    function PageMe_Dynamic(TotalPage,Page,Per,scroll,id,where)
    {
        ...
        if(typeof(id)!='undefined') 
        {
            ...
            {
                //alert(id);
                getNews_Dynamic('news01uin='+id,'',Page,Per);
            }
            else
            {
                getNews_Dynamic(where,'',Page,Per);
            }
    ...
    function getNews_Dynamic_paper(Condition,Order,Page,Per,scroll)
    {
        ...
        if(typeof(Per)==='undefined') Per = 5;
        if(typeof(Order)==='undefined') Order = '';
        $( "#newsList" ).load( "ajax/NewsPaperList.php?page="+Page+"&per="+Per+"&where="+Condition+"&order="+Order );
