...
class Log extends PDODatabase
{
    ...
    private $fields = array('uin', 'tablename', 'action', 'before', 'after', 'updatedBy', 'updatedOn');
    private $_uploadUrl = '';
    //private $field_values=array();
    //private $fields_update=array('title','detail','shortDesc','date','news01uin');
    private $update_fields = array('tablename', 'action', 'before', 'after', 'updatedBy', 'updatedOn');
